...
$sections = @('.isr_vector', '.text', '.rodata', '.ARM', '.ARM.extab', '.preinit_array', '.init_array', '.fini_array', '.data', '.bss', '._user_heap_stack')
...
[int]$flashUsed = $sectionSizes['.isr_vector'] + $sectionSizes['.text'] + $sectionSizes['.rodata'] + $sectionSizes['.ARM.extab'] + $sectionSizes['.ARM'] + $sectionSizes['.preinit_array']+ $sectionSizes['.init_array'] + $sectionSizes['.fini_array']  + $sectionSizes['.data']
